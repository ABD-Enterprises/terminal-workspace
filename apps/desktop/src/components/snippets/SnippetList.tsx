...
interface SnippetListProps {
  ...
  renderExpandedContent?: (snippet: SnippetRecord) => ReactNode;
}
...
export function SnippetList({
  ...
  return (
    <section className="flex h-full min-h-0 flex-col overflow-hidden rounded-[22px] border border-slate-800/80 bg-slate-950/55">
      <div className="grid grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)_120px_164px] gap-3 border-b border-slate-800/80 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">
        <span>Snippet</span>
        <span>Targets</span>
        <span>Last run</span>
