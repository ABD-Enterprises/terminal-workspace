...
- the Tauri shell now proxies backend discovery, JSON/binary API access, session lifecycle, native session stream I/O, and Keychain-backed runtime secret persistence
